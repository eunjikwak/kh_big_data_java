package 벡터예제;
// Vector : ArrayList 와 내부적으로 동일한 구조 입니다. 메소드의 사용 방법도 완전히 동일합니다. 멀티스레드에 안전합니다.
...
public class VectorEx1 {
    public static void main(String[] args) {
        ...
        list.add(new NameCard("동그라미","010-1234-5678",
                "ddd@gmail.com","무직","서울시 강서구 화곡동"));
        list.add(new NameCard("이준호","010-7777-5678",

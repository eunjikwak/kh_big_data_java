...
// random() : 0.0 ~ 1.0미만의 임의의 double 형 값을 생성하여 반환
//7자리의 로또 번호 생성하기
//7개의 배열을 만들고 첫번재 부터 여섯번째는 0 ~ 50 사이의 임의의 수 생성 후 대입
// 마지막 7번째는 50 ~ 100사이의 임의의 수를 만들어서 대입하고, 한번의 출력, 단 중복은 허용
...
//============================================================
        ...
        //round() : 소수점 이하가 있으면 반올림.(소수점 첫째자리에서)
        ...
        System.out.println(Math.pow(2,5)); //제곱 2의 5승

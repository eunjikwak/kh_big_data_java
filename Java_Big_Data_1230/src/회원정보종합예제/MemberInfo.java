...
public class MemberInfo { // 필드와 메소드가 있음.
    //필드 추가하기 : 필드란? 클래스 내부에서 사용하는 변수를 의미 (객체생성 시 객체 개수 만큼 생성됨)
    String name;
    int age;
    char gender;
    int jobs;
    ...
    //주어진 조건이 맞는 나이를 입력 받아서 age 필드에 저장
    public void setAge(){
        while(true){
    ...
    //주어진 조건이 맞는 성별을 입력 받아서 gender 필드에 저장
    public void setGender(){
        while(true){
            System.out.print("성별을 입력하세요 (M/F) : ");
            gender = sc.next().charAt(0); //문자열에서 첫번재문자를 입력 받음.
            switch (gender){

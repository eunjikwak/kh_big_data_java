...
// StringTokenizer : 문자열이 특정 구분자로 연결되어있는 경우, 구분자 기준으로 문자열을 관리 할 수 있음
...
public class TokenTestEx {
    public static void main(String[] args) {
        ...
        String name = sc.nextLine(); // 문자열을 개행 문자를 만날 때 까지 입력 받음
//        StringTokenizer st = new StringTokenizer(name,"/"); //배열과 구분자를 객체 생성시 넣어줌
//        String[] nameStr = new String[st.countTokens()]; //토큰의 개수 만큼 문자열 배열 생성
//        while (st.hasMoreElements()){ //남아있는 토큰이 있는동안 반복문 수행
